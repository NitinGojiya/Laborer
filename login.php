...
if (isset($_POST['login'])) {
    ...
    if ($role == 'Contractor') {
        ...
        $qry = mysqli_query($conn, $select);
        while ($row = mysqli_fetch_array($qry)) {
            if ($row['unm'] == $u_nm && $row['psw'] == $psw) {
                session_start();
                $_SESSION['cunm'] =$row['unm']; 
    ...
    <form method="POST" action="login.php">
        ...
        <header class="sticky1">
            ...
            <ul class="navlist">
                ...
                <li><a href="register.php">Rigester</a></li>
            </ul>
        </header>
        ...
        <section class="login" id="login">
            ...
            <div class="log-form-btn">
                <div class="submit_1">
                    <p><input class="submit_in" type="submit" name="login" value="Login"></p>
                </div>
            </div>
            <div class="log-form-btn">
                <div class="submit_1">
                    <p><a class="submit_in" href="forgot.php">Forgot Password?</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="register.php" class="submit_in">New User?</a></p>
                </div>
            </div>

            <input type="radio" name="role" value="laborer"> laborer
